...
been calling this the "information architecture" 🦕).
...
the old posts I deemed worthy of the light of day, fixing up obsolete formatting and
shortcodes, and defining an Astro [Content Collection]:
...
is built on it, as is its (plugin-supported) [MDX integration]. I like the feel of JSX
